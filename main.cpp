...
// TODO: this is where I left off! https://vulkan-tutorial.com/en/Vertex_buffers/Index_buffer 
...
private:
	...
	bool isDeviceSuitable(VkPhysicalDevice device) {
		//Query for properties and features
		/*
		...
		*/
		...
		/* Could also rate all devices and default to the highest rating*/
	...
	void createLogicalDevice() {
		...
		//leave everything on this struct as VK_FALSE for now
		VkPhysicalDeviceFeatures deviceFeatures{};
